...
public class VolleyR_User_changePasswordRequest extends StringRequest {

    final static private String URL = "서버URL"; //회원등록 요청할 서버주소
    private Map<String, String> parameters;

    public VolleyR_User_changePasswordRequest(String ID, String passwd, Response.Listener<String> listener) {
